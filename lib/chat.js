    ...
    const chats = await Message.aggregate([
      ...
      // Resultado final
      {
        $project: {
          ...
          mobile: '$chat.mobile',
          names: '$chat.names',
          mobileCode: '$chat.mobileCode',
          lastMessage: '$chat.lastMessage',
          previousMessage: '$chat.previousMessage',
          previousMessageType: '$chat.previousMessageType',
          lastChannel: '$chat.lastChannel',
          lastMessageType: '$chat.lastMessageType',
          lastMessageStatus: '$chat.lastMessageStatus',
          read: '$chat.read',
          count: '$chat.count',
          phoneNoId: '$chat.phoneNoId',
          auto: '$chat.auto',
